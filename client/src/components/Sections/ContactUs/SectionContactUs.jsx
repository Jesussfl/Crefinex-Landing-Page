...
function SectionLocation(props) {
   const { isDataLoading, data } = useQuery("location", () => getData("Ubicacion", "A:B"));
   const form = useRef();
   ...
   const sendEmail = (e) => {
      e.preventDefault();
      setIsLoading(true);
      emailjs.sendForm("service_0jgwxsl", "template_xaw666b", form.current, "6iK_DQEtWGw-jMvrP").then(
         (result) => {
         ...
         <section className="section-location" id="contactUs">
            <div className="contactUs-wrapper">
               <div className="copys-location">
                  ...
                  {isLoading ? (
                     ...
                     <form className="flex-container" ref={form} onSubmit={sendEmail}>
                        ...
                        <TextField
                           ...
                           onChange={handleChange}
                           title="Tu mensaje"
                           placeholder="Tu mensaje"></TextField>
                        <Button
                           style={{
                              marginTop: "16px",
                              height: "48px",
                  ...
                  <NavItem />
                  <p className="callout">{data && data.Ubicacion}</p>
               </div>
               <LazyLoad offset={400} className="map-wrapper">
                  <iframe
                     ...
                     marginHeight="0"
                     marginWidth="0"
                     src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Crefinex maracay&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
               </LazyLoad>
            </div>
         </section>
      </LazyLoad>
